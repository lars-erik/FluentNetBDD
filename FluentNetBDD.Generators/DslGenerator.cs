        ...
        private string GenerateInnerDsl(string featureName, string dslClassName, DslSet dslSet)
        {
            ...
            var builderDslClass =
                $$"""
                  public partial class {{dslClassName}} : Dsl<{{featureName}}GivenBuilder, {{featureName}}WhenBuilder, {{featureName}}ThenBuilder>
                  {
                      ...
                      {
                          var givenDriver = DslTermProxyBuilder.Create<I{{featureName}}GivenDriver>(nameof(Given), provider);
                          var whenDriver = DslTermProxyBuilder.Create<I{{featureName}}WhenDriver>(nameof(When), provider);
                          var thenDriver = DslTermProxyBuilder.Create<I{{featureName}}ThenDriver>(nameof(Then), provider);
                  
                          Given = new {{featureName}}GivenBuilder(givenDriver);
                          When = new {{featureName}}WhenBuilder(whenDriver);
                          Then = new {{featureName}}ThenBuilder(thenDriver);
                      }
                  }
                  """;
            ...
            var source =
                $$"""
                  ...
                  {{(enableBuilder ? "using System.Runtime.CompilerServices;" : "")}}
                  {{(enableBuilder ? "using FluentNetBDD.Dsl.Builders;" : "")}}
